...
export function parseDicom(bytes) {
  ...
  return {
    ...
    // Contrast/Bolus Agent and Route, and Protocol Name: used to classify the contrast phase.
    contrastAgent: text(ds, 'x00180010').slice(0, 64),
    contrastRoute: text(ds, 'x00181040').slice(0, 64),
    protocolName: text(ds, 'x00181030').slice(0, 64),
  };
}
